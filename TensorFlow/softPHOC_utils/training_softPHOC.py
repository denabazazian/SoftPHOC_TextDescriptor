...
def get_valid_entries_indices_from_annotation_batch(annotation_batch_tensor, class_labels):
    ...
    #valid_labels_mask = tf.equal(annotation_batch_tensor, class_label)
    #valid_labels_mask = annotation_batch_tensor
    #valid_labels_mask = tf.logical_or((tf.equal(annotation_batch_tensor, class_labels[0])), (tf.equal(annotation_batch_tensor, class_labels[1]), name=None))
    #valid_labels_mask = tf.logical_or((tf.equal(annotation_batch_tensor, class_labels[0])), (tf.equal(annotation_batch_tensor, class_labels[1])))
    #valid_labels_mask = tf.logical_or((tf.equal(annotation_batch_tensor, class_labels[0])), (tf.equal(annotation_batch_tensor, class_labels[1])), (tf.equal(annotation_batch_tensor, class_labels[2])), (tf.equal(annotation_batch_tensor, class_labels[3])), (tf.equal(annotation_batch_tensor, class_labels[4])), (tf.equal(annotation_batch_tensor, class_labels[5])), (tf.equal(annotation_batch_tensor, class_labels[6])), (tf.equal(annotation_batch_tensor, class_labels[7])), (tf.equal(annotation_batch_tensor, class_labels[8])), (tf.equal(annotation_batch_tensor, class_labels[9])), (tf.equal(annotation_batch_tensor, class_labels[10])), (tf.equal(annotation_batch_tensor, class_labels[11])), (tf.equal(annotation_batch_tensor, class_labels[12])), (tf.equal(annotation_batch_tensor, class_labels[13])), (tf.equal(annotation_batch_tensor, class_labels[14])), (tf.equal(annotation_batch_tensor, class_labels[15])), (tf.equal(annotation_batch_tensor, class_labels[16])), (tf.equal(annotation_batch_tensor, class_labels[17])), (tf.equal(annotation_batch_tensor, class_labels[18])), (tf.equal(annotation_batch_tensor, class_labels[19])), (tf.equal(annotation_batch_tensor, class_labels[20])), (tf.equal(annotation_batch_tensor, class_labels[21])), (tf.equal(annotation_batch_tensor, class_labels[22])), (tf.equal(annotation_batch_tensor, class_labels[23])), (tf.equal(annotation_batch_tensor, class_labels[24])), (tf.equal(annotation_batch_tensor, class_labels[25])), (tf.equal(annotation_batch_tensor, class_labels[26])), (tf.equal(annotation_batch_tensor, class_labels[27])), (tf.equal(annotation_batch_tensor, class_labels[28])), (tf.equal(annotation_batch_tensor, class_labels[29])), (tf.equal(annotation_batch_tensor, class_labels[30])), (tf.equal(annotation_batch_tensor, class_labels[31])), (tf.equal(annotation_batch_tensor, class_labels[32])), (tf.equal(annotation_batch_tensor, class_labels[33])), (tf.equal(annotation_batch_tensor, class_labels[34])), (tf.equal(annotation_batch_tensor, class_labels[35])), (tf.equal(annotation_batch_tensor, class_labels[36])), (tf.equal(annotation_batch_tensor, class_labels[37])))
    #valid_labels_mask = tf.equal(annotation_batch_tensor, class_labels[1])+ tf.equal(annotation_batch_tensor, class_labels[0])
   
    #valid_labels_mask = tf.equal(annotation_batch_tensor, class_labels[1])
    #valid_labels_mask = annotation_batch_tensor
