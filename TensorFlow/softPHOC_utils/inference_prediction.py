# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 16:43:55 2017
...
def adapt_network_for_any_size_input(network_definition, multiple):
    ...
    def new_network_definition(*args, **kwargs):
        ...
        # upsample_logit = pred.eval(session=sess) 
        # temp_pred = tf.expand_dims(upsampled_logits_batch, 3)
        
#        print "temp pred is:"
#        print temp_pred
#        print "image height-with is"
#        print image_height_width

        #original_size_predictions = tf.image.resize_nearest_neighbor(images=temp_pred, size=image_height_width)
        #import ipdb; ipdb.set_trace()
        original_size_predictions = tf.image.resize_nearest_neighbor(images=upsampled_logits_batch, size=image_height_width)
