...
# python wordSpotting_recognition_reading_GTbbx_GTtranscription.py /path/to/softPHOC_synthText/word_spotting/data/icdar_ch4_testSet/img_*.jpg
...
if __name__=='__main__':
    ...
    saver.restore(sess, tf.train.latest_checkpoint('/tf_model_3_backup_118000/'))

    img_bbx_path = "./results/dtw/dtw_GTbbx_GTtranscription_Euclidean_img_column_warped/"
    res_path = "./results/dtw/dtw_GTbbx_GTtranscription_Euclidean_res_column_warped/"
