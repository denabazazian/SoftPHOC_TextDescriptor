...
def textProposals(csvName,iimg,qHist):
    idxTP=0
...
if __name__=='__main__':
    ...
    softPhoc_net= "/path/to/softPHOC_synthText/tf_model/tf_model_3_backup_118000/model_fcn32s_118000.ckpt"
    ...
    for img_name in sys.argv[1:]:       
        ...
        iimg = getIimg(img_name,softPhoc_net,number_of_classes)
        ...
        for nqw in range(0,numQWords): 
            ...
            if (len(voc[nqw])>0 and voc[nqw].split(',')[-1].strip()!='###'):
               ...
               res=textProposals(csvName,iimg,qHist)
