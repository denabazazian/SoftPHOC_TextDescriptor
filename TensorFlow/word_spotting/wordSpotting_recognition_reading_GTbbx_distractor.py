# -*- coding: utf-8 -*-
"""
Created on Thu Jun 07 07 2018 19:07:21

@author: dena
"""
# cd  GT_recognition
# python wordSpotting_recognition_reading_GTbbx_distractor_GT.py /path/to/softPHOC_synthText/word_spotting/data/icdar_ch4_testSet/img_*.jpg
...
if __name__=='__main__':
    ...
    res_path = "/softPHOC_synthText/word_spotting/results/recognition_GTbbx/Reading_gtbbx_CE2_distractors_withoutThreshold_withoutIF/"
    score_path = "/softPHOC_synthText/word_spotting/results/recognition_GTbbx/Reading_gtbbx_CE2_distractors_withoutThreshold_withoutIF_scores/"
    ...
    for img_name in sys.argv[1:]:
        ...
        for l in range(0, numGTs):
            if (len(gt_file[l])>0 and gt_file[l].split(',')[-1].strip()!='###'):
                ...
                transcription = gt_file[l].split(',')[8]
                # print transcription
