...
from dataloaders.generate_segLabels_icdar import generate_segmentation_softPHOC_labels
...
class ICDARSegmentation(Dataset):
    ...
    # this not sure
    def __str__(self):
        return 'icdar(split=' + str(self.split) + ')'
...
if __name__ == '__main__':
    ...
    dataloader = DataLoader(icdar_train, batch_size=2, shuffle=True, num_workers=4)
