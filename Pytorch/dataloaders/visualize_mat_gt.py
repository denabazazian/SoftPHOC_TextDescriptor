...
#python visualize_mat_gt.py /path/to/deeplabV3Plus/icdar_models_softPHOC/img_49.mat
...
if __name__=='__main__':    
    ...
    save_softPHOC_hm_path = '/path/to/deeplabV3Plus/icdar_models_softPHOC/softPHOC_test/softPHOC_png/levels/'
    ...
    #for test in range(0,1):  
        ...
        img_path = '/path/to/ICDAR2015/ch4_train_img/'+'img_126.jpg'   #imgName
        print(img_path)
